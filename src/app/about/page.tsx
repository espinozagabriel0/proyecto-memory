    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 p-6 rounded">
        <p className="md:w-1/2 text-justify">
          ...
          para ver cómo mejoras, y crear una cuenta para guardar tus resultados.
          Además, podrás explorar las partidas de otros jugadores, descubrir sus
          mejores tiempos, estrategias, y competir en los rankings para demostrar
          tus habilidades. !A jugar!
        </p>
